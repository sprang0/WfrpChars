...
namespace WfrpChars.Data.Careers
{
    class Apothecary : CareerBase
    {
        ...
        {
            { 1, new List<SkillType> { SkillType.ConsumeAlcohol, SkillType.Heal, SkillType.LanguageClassical, SkillType.LoreChemistry, SkillType.LoreMedicine, SkillType.LorePlants, SkillType.TradeApothecary, SkillType.TradePoisoner } },
        ...
        public override Dictionary<int, List<TalentType>> Talents => new()
        {
            ...
            { 4, new List<TalentType> { TalentType.AccuteSenseTaste, TalentType.Coolheaded, TalentType.MasterTradesmanPoisoner, TalentType.SavantApothecary } }
        };
    }
}
